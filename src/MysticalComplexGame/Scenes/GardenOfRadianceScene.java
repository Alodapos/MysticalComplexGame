...
public class GardenOfRadianceScene implements IScene
{
    ...
    public GardenOfRadianceScene(String north, String south, String east, String west, IItem... items)
    {
        ...
        this.sceneName = "Garden of Radiance";
